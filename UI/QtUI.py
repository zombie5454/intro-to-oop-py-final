...
"}")
        ...
        self.choice_1 = QtWidgets.QRadioButton(self.choice)
        self.choice_1.setObjectName("choice_1")
        self.verticalLayout_8.addWidget(self.choice_1)
        self.choice_2 = QtWidgets.QRadioButton(self.choice)
        self.choice_2.setObjectName("choice_2")
        self.verticalLayout_8.addWidget(self.choice_2)
        self.choice_3 = QtWidgets.QRadioButton(self.choice)
        self.choice_3.setObjectName("choice_3")
        self.verticalLayout_8.addWidget(self.choice_3)
        self.choice_4 = QtWidgets.QRadioButton(self.choice)
        self.choice_4.setObjectName("choice_4")
        self.verticalLayout_8.addWidget(self.choice_4)
        ...
        self.multipleChoice_1 = QtWidgets.QRadioButton(self.multipleChoice)
        self.multipleChoice_1.setAutoExclusive(False)
        self.multipleChoice_1.setObjectName("multipleChoice_1")
        self.verticalLayout_10.addWidget(self.multipleChoice_1)
        self.multipleChoice_2 = QtWidgets.QRadioButton(self.multipleChoice)
        self.multipleChoice_2.setAutoExclusive(False)
        self.multipleChoice_2.setObjectName("multipleChoice_2")
        self.verticalLayout_10.addWidget(self.multipleChoice_2)
        self.multipleChoice_3 = QtWidgets.QRadioButton(self.multipleChoice)
        self.multipleChoice_3.setAutoExclusive(False)
        self.multipleChoice_3.setObjectName("multipleChoice_3")
        self.verticalLayout_10.addWidget(self.multipleChoice_3)
        self.multipleChoice_4 = QtWidgets.QRadioButton(self.multipleChoice)
        self.multipleChoice_4.setAutoExclusive(False)
        self.multipleChoice_4.setObjectName("multipleChoice_4")
        self.verticalLayout_10.addWidget(self.multipleChoice_4)
        ...
        self.exam_shortAnswer = QtWidgets.QWidget()
        self.exam_shortAnswer.setObjectName("exam_shortAnswer")
        self.verticalLayout_19 = QtWidgets.QVBoxLayout(self.exam_shortAnswer)
        self.verticalLayout_19.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.plainTextEdit = QtWidgets.QPlainTextEdit(self.exam_shortAnswer)
        self.plainTextEdit.setObjectName("plainTextEdit")
        self.verticalLayout_19.addWidget(self.plainTextEdit)
        self.stackedExamAnswer.addWidget(self.exam_shortAnswer)
        self.exam_choice = QtWidgets.QWidget()
        self.exam_choice.setObjectName("exam_choice")
        self.verticalLayout_16 = QtWidgets.QVBoxLayout(self.exam_choice)
        self.verticalLayout_16.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.exam_choice_1 = QtWidgets.QRadioButton(self.exam_choice)
        self.exam_choice_1.setObjectName("exam_choice_1")
        self.verticalLayout_16.addWidget(self.exam_choice_1)
        self.exam_choice_2 = QtWidgets.QRadioButton(self.exam_choice)
        self.exam_choice_2.setObjectName("exam_choice_2")
        self.verticalLayout_16.addWidget(self.exam_choice_2)
        self.exam_choice_3 = QtWidgets.QRadioButton(self.exam_choice)
        self.exam_choice_3.setObjectName("exam_choice_3")
        self.verticalLayout_16.addWidget(self.exam_choice_3)
        self.exam_choice_4 = QtWidgets.QRadioButton(self.exam_choice)
        self.exam_choice_4.setObjectName("exam_choice_4")
        self.verticalLayout_16.addWidget(self.exam_choice_4)
        self.stackedExamAnswer.addWidget(self.exam_choice)
        self.exam_multipleChoice = QtWidgets.QWidget()
        self.exam_multipleChoice.setObjectName("exam_multipleChoice")
        self.verticalLayout_17 = QtWidgets.QVBoxLayout(self.exam_multipleChoice)
        self.verticalLayout_17.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_17.setObjectName("verticalLayout_17")
        self.exam_multipleChoice_1 = QtWidgets.QRadioButton(self.exam_multipleChoice)
        self.exam_multipleChoice_1.setAutoExclusive(False)
        self.exam_multipleChoice_1.setObjectName("exam_multipleChoice_1")
        self.verticalLayout_17.addWidget(self.exam_multipleChoice_1)
        self.exam_multipleChoice_2 = QtWidgets.QRadioButton(self.exam_multipleChoice)
        self.exam_multipleChoice_2.setAutoExclusive(False)
        self.exam_multipleChoice_2.setObjectName("exam_multipleChoice_2")
        self.verticalLayout_17.addWidget(self.exam_multipleChoice_2)
        self.exam_multipleChoice_3 = QtWidgets.QRadioButton(self.exam_multipleChoice)
        self.exam_multipleChoice_3.setAutoExclusive(False)
        self.exam_multipleChoice_3.setObjectName("exam_multipleChoice_3")
        self.verticalLayout_17.addWidget(self.exam_multipleChoice_3)
        self.exam_multipleChoice_4 = QtWidgets.QRadioButton(self.exam_multipleChoice)
        self.exam_multipleChoice_4.setAutoExclusive(False)
        self.exam_multipleChoice_4.setObjectName("exam_multipleChoice_4")
        self.verticalLayout_17.addWidget(self.exam_multipleChoice_4)
        self.stackedExamAnswer.addWidget(self.exam_multipleChoice)
        self.gridLayout_9.addWidget(self.stackedExamAnswer, 3, 2, 1, 1)
        self.label_11 = QtWidgets.QLabel(self.examPage)
        self.label_11.setObjectName("label_11")
        self.gridLayout_9.addWidget(self.label_11, 0, 1, 1, 1)
        self.comboBox = QtWidgets.QComboBox(self.examPage)
        ...
        self.stackedExamAnswer.setCurrentIndex(2)
    ...
    def retranslateUi(self, Widget):
        ...
        self.choice_1.setText(_translate("Widget", "RadioButton"))
        self.choice_2.setText(_translate("Widget", "RadioButton"))
        self.choice_3.setText(_translate("Widget", "RadioButton"))
        self.choice_4.setText(_translate("Widget", "RadioButton"))
        self.multipleChoice_1.setText(_translate("Widget", "RadioButton"))
        self.multipleChoice_2.setText(_translate("Widget", "RadioButton"))
        self.multipleChoice_3.setText(_translate("Widget", "RadioButton"))
        self.multipleChoice_4.setText(_translate("Widget", "RadioButton"))
        ...
        self.exam_choice_1.setText(_translate("Widget", "RadioButton"))
        self.exam_choice_2.setText(_translate("Widget", "RadioButton"))
        self.exam_choice_3.setText(_translate("Widget", "RadioButton"))
        self.exam_choice_4.setText(_translate("Widget", "RadioButton"))
        self.exam_multipleChoice_1.setText(_translate("Widget", "RadioButton"))
        self.exam_multipleChoice_2.setText(_translate("Widget", "RadioButton"))
        self.exam_multipleChoice_3.setText(_translate("Widget", "RadioButton"))
        self.exam_multipleChoice_4.setText(_translate("Widget", "RadioButton"))
        self.label_11.setText(_translate("Widget", "題型"))
        self.comboBox.setCurrentText(_translate("Widget", "單選"))
        self.comboBox.setItemText(0, _translate("Widget", "單選"))
        self.comboBox.setItemText(1, _translate("Widget", "多選"))
        self.comboBox.setItemText(2, _translate("Widget", "填充"))
