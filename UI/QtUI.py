...
"}")
        ...
        self.stackedWidget = QtWidgets.QStackedWidget(self.editQuestionPage)
        self.stackedWidget.setObjectName("stackedWidget")
        self.page = QtWidgets.QWidget()
        self.page.setObjectName("page")
        self.questionAnswer = QtWidgets.QPlainTextEdit(self.page)
        self.questionAnswer.setGeometry(QtCore.QRect(30, -30, 670, 192))
        ...
        self.gridLayout_6.addWidget(self.stackedWidget, 3, 1, 1, 1)
